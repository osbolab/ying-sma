...
public:
  ...
  //! Receive a content metadata ann.
  /*! A metadata ann indicates that a piece of content is available
  ...
  //! Store a piece of a content locally and broadcast a metadata ann
  //! to the network.
